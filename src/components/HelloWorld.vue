<template>
  ...
  <div class="hello">
    ...
    <table>
      ...
      <tbody>
        <tr
          v-for="(schooldayName, subjectName, id) in hoursByEmployee"
          :key="subjectName"
        >
...
import { useSchooldays } from "../store/schooldays"
...
export default {
  ...
  setup(props,  { emit }) {
    ...
    //     period: "AM",
    //   },
    //   { id: 1, schoolday: 1, subject: 7, nr: "I  14:00 – 14:45", period: "PM" },
    //   {
    //     id: 2,
    //     schoolday: 1,
    //     subject: 9,
    ...
    //     period: "PM",
    //   },
    //   { id: 5, schoolday: 1, subject: 13, nr: "V  17:35 – 18:20", period: "PM" },
    //   {
    //     id: 6,
    //     schoolday: 1,
    //     subject: 4,
    ...
    //     period: "PM",
    //   },
    //   { id: 7, schoolday: 2, subject: 5, nr: "I  14:00 – 14:45", period: "PM" },
    //   {
    //     id: 8,
    //     schoolday: 2,
    //     subject: 2,
    ...
    const timetable_store = useTimetable()
    const timetable = timetable_store.getTimetable
    const schooldays_store = useSchooldays()
    const schooldays = schooldays_store.getSchooldays
    const subjects_store = useSubjects()
    const subjects = subjects_store.getSubjects
    const times = computed(() => {
      return timetable.map((t) => {
        let schooldayName = schooldays.filter(
          (s) => s.id === t.schoolday
        )[0].name;
        let subjectName = subjects.filter((s) => s.id === t.subject)[0]
          .name;
    ...
    const hoursByEmployee = computed(() => {
      return header.value.reduce((r, o) => {
        r[o.nr] ??= {};
        //r[o.nr][o.schooldayName] = {name:o.subjectName, id: o.id};
